  ...
  <nav class="ampstart-sidebar-nav ampstart-nav">
    <ul class="list-reset m0 p0 ampstart-label">
        ...
        <li>
          ...
          <amp-img src="/<?php echo lay_banner('logo')?>" width="92" height="55" layout="responsive" class="ampstart-sidebar-nav-image inline-block mb4" alt="Company logo" noloading="">
            <div placeholder="" class="commerce-loader"></div>
          </amp-img>
          </a>
        </li>

          <li class="ampstart-nav-item "><a class="ampstart-nav-link" href="/index.php"><?php echo _trangchu?></a></li>

          <li class="ampstart-nav-item "><a class="ampstart-nav-link" href="/gioi-thieu.html"><?php echo _gioithieu?></a></li>

          <amp-accordion class="ampstart-nav-item">
              <section>
                <h4 class="ampstart-nav-link product-menu"><?php echo _sanpham?></h4>
                <?php echo for2cap('product_danhmuc','product_list','/bat-dong-san','bat-dong-san','','/')?>
              </section>
            </amp-accordion>

          <li class="ampstart-nav-item "><a class="ampstart-nav-link" href="/dich-vu.html"><?php echo _dichvu?></a></li>
          <li class="ampstart-nav-item "><a class="ampstart-nav-link" href="/tin-tuc.html"><?php echo _tintuc?></a></li>
          <li class="ampstart-nav-item "><a class="ampstart-nav-link" href="/tuyen-dung.html"><?php echo _tuyendung?></a></li>
          <li class="ampstart-nav-item "><a class="ampstart-nav-link" href="/nhu-cau-khach-hang.html">Nhu cầu khách hàng</a></li>

          <li class="ampstart-nav-item "><a class="ampstart-nav-link" href="/lien-he.html"><?php echo _lienhe?></a></li>
